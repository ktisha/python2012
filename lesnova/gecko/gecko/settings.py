...
import os
_PATH = os.path.abspath(os.path.dirname(__file__)).replace("\\", "/")
...
STATICFILES_DIRS = (
    os.path.join(_PATH, "static").replace("\\", "/"),
...
SECRET_KEY = '0ai_n$_leqr!2+l#_#t*y77=6yaojor(ye$-zf$#64r_)^e$ai'
...
TEMPLATE_DIRS = (os.path.join(_PATH, 'templates').replace("\\", "/"),)
