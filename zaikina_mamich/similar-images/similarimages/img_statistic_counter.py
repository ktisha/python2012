...
class ImgStatisticCounter:
    ...
    def __init__(self, image = None, path = ""):
        ...
        self.standard_deviation = (math.sqrt(self.dispersion[0]), math.sqrt(self.dispersion[1]), math.sqrt(self.dispersion[2]))
...
#        return [ImgStatisticCounter.__distance_(ref_statistic)]
        ...
        expected_values_distance = ImgStatisticCounter.color_distance(self.expectation_value, ref_statistic.expectation_value)
...
def histogram_matching_distance(hist1, hist2):
    ...
    def inner_histogram_matching_distance(hist1, hist2, colour_num = ColorValueTransform.rgb_to_number((255, 255, 255)) + 1):
